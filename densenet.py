...
from networks import custom_softmax_activation


def DenseNet(input_shape=None, dense_blocks=3, dense_layers=-1, growth_rate=12, nb_classes=None, dropout_rate=None,
             bottleneck=False, compression=1.0, weight_decay=1e-4, depth=40, last_activation='linear'):
    """
    Creating a DenseNet
    ...
    x = Dense(nb_classes, activation=last_activation,
...
if __name__ == '__main__':
    dn, _ = DenseNet((64, 64, 1), nb_classes=6)
    from keras.utils import plot_model
    plot_model(dn, 'model.png')
    dn.summary()
